...
final ParagraphTextStyle =GoogleFonts.alexandria(
    color: SubTitleColor, fontWeight: FontWeight.w400, fontSize: 0.03.sw);
final IconTextStyle = GoogleFonts.alexandria(fontSize: 0.0246.sw);
final LiveTextStyle=GoogleFonts.alexandria(fontSize: 0.03.sw,color: WhiteColor);
final SectionNameTextStyle = GoogleFonts.alexandria(
    color: SubTitleColor, fontWeight: FontWeight.w400, fontSize: 10);


final SpecialTextStyle = GoogleFonts.alexandria(
    color: WhiteColor, fontWeight: FontWeight.w400, fontSize: 30.w);
final PriceTextStyle = GoogleFonts.alexandria(
    color: WhiteColor, fontWeight: FontWeight.w900, fontSize: 60.w);
